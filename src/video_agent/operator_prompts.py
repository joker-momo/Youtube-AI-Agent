...
def _chatgpt_scenes_prompt(
    ...
    prompt_parts = [
        ...
        "- layout: one of [\"hook\", \"subtitle\", \"checklist\", \"warning\", \"quote\", \"cta\", \"stat\", \"steps\", \"comparison\", \"myth\"].",
        ...
        "- ⚠️ VISUAL RHYTHM (critical for retention): the graphic layouts (hook/checklist/warning/quote/cta/stat/steps/comparison/myth) render as full design cards. Two or more cards back-to-back feel like a static slideshow and lose viewers. NEVER place two graphic-layout scenes consecutively — separate EVERY graphic scene with at least one (ideally two) layout=\"subtitle\" narrative scene(s) that play over moving video. This applies right after the scene-01 hook too: scene-02 onward must be \"subtitle\" until the next genuine card moment. Most scenes should be \"subtitle\"; spread the graphic cards sparingly across the whole script.",
...
def _chatgpt_scenes_batch_prompt(
    ...
    parts = [
        ...
        "- layout must be one of: hook, subtitle, checklist, warning, quote, cta, stat, steps, comparison, myth.",
