...
def _chatgpt_seo_prompt(
    ...
    return "\n".join(
        [
            ...
            "  • thumbnail_text: 3-6 words ALL-CAPS Spanish. It is a STANDALONE MICRO-PROMISE: a viewer aged 45-75 must understand, without reading the YouTube title, what familiar problem/object the video concerns and what practical value they get.",
