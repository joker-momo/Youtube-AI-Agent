...
def gemini_script_qa_prompt(
    ...
    return (
        ...
        "- If narration_seed has more or fewer ordinal words (e.g. Primero, Segundo, Tercero, Cuarto, Quinto) than idea_contract.original_count, it must NOT fail QA or produce a HARD_BLOCKER. It may only produce a WARN.\n\n"
