...
def gemini_scenes_qa_prompt(channel_config: dict, short_script: dict, short_scenes: dict) -> str:
    ...
    return (
        ...
        "4. Payoff Scene (s07):\n"
        "   - Must use 'graphic_checklist' layout with title \"MEJOR ASÍ\" and checklist items: \"Porción visible\", \"Plato pequeño\", \"Comida completa\". Do not use plate ratio.\n"
        "5. Visual Specificity:\n"
