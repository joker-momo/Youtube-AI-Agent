...
def short_scene_prompt_v6(
    ...
    *,
    ...
    return (
        ...
        "  - graphic_quote_portrait: max 8–10 spoken words\n"
        ...
        "- graphic_stat         -> ONE memorable number/quantity the narration centers on (\"3 pasos\", \"2 veces al día\", \"80%\").\n"
        ...
        "- graphic_quote_portrait -> the most emotional/transitional sentence featured magazine-style beside a mature-adult portrait.\n"
        "- graphic_evidence_nugget -> a single credible number/fact tied to age/health (\"después de los 60\", \"masa muscular\").\n"
        ...
        "- graphic_quote_portrait: target 2.5–4.0 sec, hard max 4.5 sec.\n"
        "- graphic_evidence_nugget: target 2.5–3.5 sec, hard max 4.0 sec.\n"
        ...
        "graphic_quote_portrait: {\"title\": \"Comer bien no es comer menos\", \"footer\": \"...\"} "
        "(title = the featured sentence, max 60 chars).\n"
        "graphic_evidence_nugget: {\"title\": \"Después de los 60\", \"body\": \"la masa muscular "
        "cae más rápido\", \"footer\": \"...\"} (title = number/fact, body = short context).\n"
        ...
        "Use graphic_stat when the narration centers on ONE memorable number; graphic_evidence_nugget\n"
        "when that number/fact is tied to age/health and needs documentary credibility.\n"
        ...
        "Use graphic_quote_portrait only for the single most emotional/memorable sentence.\n"
