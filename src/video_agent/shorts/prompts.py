...
def short_scene_prompt_v6(channel_config: dict, short_plan: dict,
    ...
    return (
        ...
        "For a normal Short, use 1–2 graphics normally; use 3 only if intentionally graphic-led and pacing remains strong.\n"
        ...
        "For bread/food-label Shorts, a good sequence is: hook with clear bread/label visual; short myth/setup; graphic checklist for busca integral; lifestyle reinforcement; graphic label callout; action CTA.\n\n"
