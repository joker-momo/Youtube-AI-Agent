...
def build_thumbnail_prompt(plan: dict) -> str:
    return (
        ...
        "PREMIUM EDITORIAL STANDARD: make it feel like a trusted Spanish health-and-"
        "lifestyle magazine cover photographed for this exact story: restrained, tactile, "
        "credible, and polished without luxury clichés. For viewers aged 45-75, favor an "
        "immediately recognizable real-life situation, one focal action, generous negative "
        "space, and large literal evidence over clever symbolism or decoration.\n"
        "\n"
