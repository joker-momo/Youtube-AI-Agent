...
def test_call_budget_schema_matches_spec_v_fix():
    ...
    assert set(s["by_reason"]) == {
        ...
        "audio_fit_fail", "renderer_contract_fail", "wrong_context_suppressed", "noncanonical_count_inference", "retention_grammar_repair", "retry_collapse", "duration_normalized", "deterministic_repair", "visual_repair_downgraded", "unknown",
    }
